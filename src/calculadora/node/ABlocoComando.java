...
public final class ABlocoComando extends PComando
{
    ...
    private final LinkedList<PComando> _dir_ = new LinkedList<PComando>();
    ...
    public LinkedList<PComando> getDir()
    {
        return this._dir_;
    }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        for(ListIterator<PComando> i = this._dir_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
